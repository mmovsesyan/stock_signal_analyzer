...
# Порог для генерации торгового плана: |score| < _DIR_THRESHOLD = упрощённый план
# Должен быть ниже минимального B-tier (0.14 aligned), иначе B-класс получит _simple_plan.
_DIR_THRESHOLD = 0.12

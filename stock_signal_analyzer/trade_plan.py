...
# Порог для генерации торгового плана: |score| < 0.23 = недостаточная чёткость сигнала
# Должен быть ниже минимального B-tier (0.24 aligned), иначе B-класс получит _simple_plan.
_DIR_THRESHOLD = 0.23
...
_DEFAULT_PARAMS = (1.5, 2.8, 4.0, 15, 15)
